...
/// My Orders — active vs completed sections from [GET /api/Order/customer].
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return ordersAsync.when(
          data: (orders) {
            final active = activeCustomerOrders(orders);
            final completed = completedCustomerOrders(orders);
                  ...
                  child: Align(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Padding(
                        ...
                        child:
                            _SectionTitle(text: l10n.myOrdersCompletedSection),
                      ),
                    ),
                  ),
                ),
